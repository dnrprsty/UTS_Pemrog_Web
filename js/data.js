...
// Fungsi untuk mendapatkan data pengguna dari localStorage atau menggunakan data default
function getDataPengguna() {
    ...
    // Cek di localStorage, jika ada, gunakan. Jika tidak, pakai default.
    let data = localStorage.getItem('dataPengguna');
    return data ? JSON.parse(data) : defaultData;
}

// Data katalog buku
const dataKatalogBuku = [
    { kodeBarang: "ASIP4301", namaBarang: "Pengantar Ilmu Komunikasi", jenisBarang: "Buku Ajar", edisi: "2", stok: 548, harga: 180000, cover: "img/pengantar_komunikasi.jpg" },
    { kodeBarang: "EKMA4002", namaBarang: "Manajemen Keuangan", jenisBarang: "Buku Ajar", edisi: "3", stok: 392, harga: 220000, cover: "img/manajemen_keuangan.jpg" },
    { kodeBarang: "EKMA4310", namaBarang: "Kepemimpinan", jenisBarang: "Buku Ajar", edisi: "1", stok: 278, harga: 150000, cover: "img/kepemimpinan.jpg" },
    { kodeBarang: "BIOL4211", namaBarang: "Mikrobiologi Dasar", jenisBarang: "Buku Ajar", edisi: "2", stok: 165, harga: 200000, cover: "img/mikrobiologi.jpg" },
    { kodeBarang: "PAUD4401", namaBarang: "Perkembangan Anak Usia Dini", jenisBarang: "Buku Ajar", edisi: "4", stok: 204, harga: 250000, cover: "img/paud_perkembangan.jpg" }
];
...
// Data riwayat pesanan (History Transaksi) - Disimpan di localStorage
function getHistory() {
